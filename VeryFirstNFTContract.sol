...
contract VeryFirstNFTContract is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://NOT_ACTUALLY_A_URI";

  constructor() 
    ERC721("NFT Collection TEST", "NCT")
    RandomlyAssigned(10, 1)
    {
       for (uint256 a = 1; a <= 10; a++) {
            mint(); // mint 10 nfts for the team
        }
    }
